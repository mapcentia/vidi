...
const resolutions = {
    EPSG3857: [156543.033928, 78271.516964, 39135.758482, 19567.879241, 9783.9396205,
    ...
    EPSG25832: [1638.4, 819.2, 409.6, 204.8, 102.4, 51.2, 25.6, 12.8, 6.4, 3.2, 1.6, 0.8,
...
const projections = {
    ...
    EPSG25832: new L.Proj.CRS('EPSG:25832',
        '+proj=utm +zone=32 +ellps=GRS80 +units=m +no_defs', {
            resolutions: resolutions.EPSG25832,
            origin: [120000, 6500000],
            bounds: L.bounds([120000, 5661139.2], [1378291.2, 6500000])
        }),
}

const getProjection = (epsg = 'EPSG3857') => {
    return projections[epsg];
}

const getResolutions = (epsg = 'EPSG3857') => {
