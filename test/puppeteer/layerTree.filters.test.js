...
const createPage = async () => {
    ...
    await page.goto(`https://vidi.alexshumilov.ru/app/aleksandrshumilov/test/#stamenTonerLite/13/39.2681/-6.8108/v:test.testpointfilters`);
...
describe('Layer tree filters', () => {
    it('should store its state', async () => { });
    it('should allow adding and deleting rules', async () => { });
    it('should allow AND and OR modes of filtering', async () => { });
