(function () {
    ...
    L.TileLayer.WMTS = L.TileLayer.extend({
        ...
        getTileUrl: function (coords) {
            const zoom = this._tileZoom.toString();
            if (this.wmtsParams.tileMatrixTransform) {
                const s = Function('"use strict";return (' + this.wmtsParams.tileMatrixTransform + ')')();
                this.wmtsParams.tileMatrix = s(zoom)
            } else {
                this.wmtsParams.tileMatrix = zoom;
            }
