...
L.Control.BoxZoom = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.controlDiv = L.DomUtil.create('div', 'leaflet-control-boxzoom leaflet-bar');
        this.controlDiv.style.width = '30px';
        this.controlDiv.style.height = '30px';
        ...
        if (this.options.iconClasses) {
            var controlA = L.DomUtil.create('a', 'leaflet-bar-part leaflet-bar-part-single', this.controlDiv);
            controlA.title = this.options.title;
            var iconElement = L.DomUtil.create('span', this.options.iconClasses, controlA);
            if (iconElement) {
